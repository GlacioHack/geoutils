...
# The remaining operation/execution pairs are measured once with a fixed input configuration
...
# Use one parameterized ASV class so every remaining operation/execution pair uses the same measurements
