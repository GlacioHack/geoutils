...
man_pages = [
    (master_doc, 'GeoUtils', 'GeoUtils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GeoUtils', 'GeoUtils Documentation',
     author, 'GeoUtils', 'Geoscientific tools.',
     'Miscellaneous'),
]
...
text_dev = ('.. warning:: \n\n'
            ...
            '`geoutils.readthedocs.org/en/stable '
            '<http://geoutils.readthedocs.org/en/stable/>`_.\n')
